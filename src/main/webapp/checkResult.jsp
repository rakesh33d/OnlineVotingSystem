...
<link rel="stylesheet" type="text/css" href="style.css">
 ...
 //create connection with database
	...
	java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinevotingdb","root","Raka@050599");
	//group the parties by count
	...
	//populate these values int string
    int i=0;
    while(rs.next()){
    	...
    	if(rs.getString("party").equals("NOTA"))
...
<tr>
<td>
<img src="images/bjp.jpeg" alt="BJP">
</td>
<td>BJP</td>
<td><%=a[1]%></td>
</tr>
...
<tr>
<td>
<img src="images/nota.png" alt="NOTA">
</td>
<td>NOTA</td>
<td><%=a[4]%></td>
</tr>
